...
Keywords: status, auth, sync, health, logged in, initialized, daemon, check,
state, connected
...
**Symptom:** Status shows authentication as missing or expired **Solution:** Run
`ox login` to authenticate with SageOx cloud

### Not initialized

**Symptom:** Status shows no SageOx configuration **Solution:** Run `ox init` to
initialize SageOx in this repository

### Daemon not running

**Symptom:** Status shows daemon as offline or unreachable **Solution:** Run
